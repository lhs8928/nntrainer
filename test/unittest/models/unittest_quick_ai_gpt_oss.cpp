 ...
 *
 * @file   unittest_quick_ai_gpt_oss.cpp
 * @date   15 June 2026
...
using TinyGptOssCausalLM =
  quick_ai_test::CausalLMTestAdapter<quick_ai::GptOssForCausalLM>;
 ...
 */
quick_ai::json makeTinyGptOssConfig() {
  return {
...
makeGptOssLayerDtypeMap(const quick_ai_test::TinyCausalLMDataType &data_type) {
...
makeGptOssCase(const quick_ai_test::TinyCausalLMDataType &data_type) {
  return {
...
INSTANTIATE_TEST_SUITE_P(
  ...
  ::testing::Values(makeGptOssCase(quick_ai_test::makeTinyFp32DataType())),
