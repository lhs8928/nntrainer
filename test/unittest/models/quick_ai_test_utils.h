...
struct TinyCausalLMConfig {
  quick_ai::json model;      /**< config.json equivalent */
  quick_ai::json generation; /**< generation_config.json equivalent */
  quick_ai::json nntrainer;  /**< nntrainer_config.json equivalent */
};
 ...
 *
 * @tparam ModelBase Concrete CausalLM model (e.g. quick_ai::Qwen3CausalLM)
 */
...
public:
   ...
   */
  CausalLMTestAdapter(quick_ai::json &cfg, quick_ai::json &generation_cfg,
   ...
   * @brief Get whether the model has completed run()
   */
  bool hasRun() const override { return quick_ai::CausalLM::hasRun(); }
 ...
 *
 * @tparam ModelBase Concrete embedding model (e.g. quick_ai::Qwen3Embedding)
 */
template <typename ModelBase>
...
public:
   ...
   */
  EmbeddingTestAdapter(quick_ai::json &cfg, quick_ai::json &generation_cfg,
                       quick_ai::json &nntr_cfg) :
    quick_ai::Transformer(cfg, generation_cfg, nntr_cfg,
...
struct TinyCausalLMCase {
  ...
  std::function<std::unique_ptr<TinyCausalLMRunner>(
    quick_ai::json &, quick_ai::json &, quick_ai::json &)>
    create_model;
   ...
   */
  std::function<quick_ai::json(const std::filesystem::path &,
                               const TinyCausalLMDataType &)>
 ...
 *
 * Checks NNTRAINER_QUICK_AI_FIXTURE_DIR env first, then uses
 ...
 */
quick_ai::json makeTinyGenerationConfig();
