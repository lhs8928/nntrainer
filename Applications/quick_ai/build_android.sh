...
# This script builds libquick_ai_core.so and nntrainer_quick_ai executable
set -e
...
# Step 4: Build CausalLM (libquick_ai_core.so and nntrainer_quick_ai)
...
log_info "  - nntrainer_quick_ai (main application), nntr_quantize, nntr_safetensors_info"
log_info "Libraries:"
