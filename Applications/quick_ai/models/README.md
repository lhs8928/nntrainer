...
| `qwen3_quick_ai` | **0.6B, 1.7B, 4B, 8B, 14B, 32B** | 📦 Standard | - | Basic implementation of the Qwen3 model. |
| `qwen3_moe_quick_ai` | **30B-A3B** | 📦 Standard | - | Basic implementation of the Qwen3 MoE model. |
| `qwen3_slim_moe_quick_ai` | **30B-A3B** | 🛠️ **Variant** | 🍃 **Slim** | Activated by FSU scheme (On-the-fly expert loading). |
| `qwen3_cached_slim_moe_quick_ai` | **30B-A3B** | 🛠️ **Variant** | ⚡ **Cached Slim** | MoE-specific FSU implementation with **expert caching**. |
| `gptoss_quick_ai` | **20B-A3.6B, 120B-5.1B** | 📦 Standard | - | Basic implementation of the GPT-OSS model. |
| `gptoss_cached_slim_quick_ai` | **20B-A3.6B, 120B-5.1B** | 🛠️ **Variant** | ⚡ **Cached Slim** | GPT-OSS MoE implementation with **expert caching**. |
...
- `*_causal_lm.cpp`: The model implementation class.
