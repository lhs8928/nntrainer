...
#ifdef ENABLE_FP16
/**
 * @brief FP16-storage exact-erf GELU (x86: scalar fallback). Used by
 * ActiFunc::gelu for FP16 (W8A16) tensors. ARM provides the NEON vectorized
 * version; x86 delegates to __fallback_gelu_v2.
 *
 * @param N number of elements in X
